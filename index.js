...
// без остачі тільки на себе та на 1). Використовуйте цикл для перевірки ділення
// числа на всі можливі дільники.

function isPrimeNumber(num) {
  // Якщо число num менше або дорівнює 1, то воно не є простим, тому повертаємо false В іншому випадку продовжуємо перевірку Запускаємо цикл для змінної i від 2 до num-1 Перевіряємо, чи num ділиться націло на поточне значення i Якщо так, то num не є простим, тому повертаємо false Якщо під час циклу не знайдено дільників, то num є простим, тому повертаємо true
  ...
  for (let i = 2; i < num; i++) {
    if (num % i === 0) {
      return false; // Знайдено дільник, отже, число не є простим
    }
  }

  return true; // Після перевірки всіх можливих дільників число залишилося простим
}
...
function isPositiveNumber(num) {
  ...
  // Перевіряємо, чи число num більше 0
  if (num > 0) {
    return true; // num є позитивним числом
  } else {
    return false; // num не є позитивним числом
  }
}
...
function isEmptyString(str) {
  ...
  if (str === "") {
    return true; // Рядок str дорівнює пустому рядку, тому він є порожнім
  } else {
    return false; // Рядок str має хоча б один символ, тому він не є порожнім
  }
}
...
function checkDataType(value) {
  ...
  const checkDataType = typeof value;
...
function findMax(num1, num2) {
  ...
  if (num1 > num2) {
    return num1; // num1 більше num2, тому повертаємо num1
  } else {
    return num2; // num2 більше або дорівнює num1, тому повертаємо num2
  }
}
...
function factorial(n) {
  ...
  // Базовий випадок: якщо n дорівнює 0 або 1, повертаємо 1
  if (n === 0 || n === 1) {
    return 1;
  } else {
    // Рекурсивний випадок: множимо n на результат виклику функції з n-1
...
function makeAdder(x) {
  ...
  // Повертаємо нову функцію, яка приймає `y` і додає його до `x`
  return function (y) {
    return x + y;
  };
}
...
function compose(func1, func2) {
  ...
  return function (n) {
    // Виконуємо func2, передаючи їй результат func1 з аргументом n
